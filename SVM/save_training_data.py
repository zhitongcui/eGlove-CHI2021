...
class serialPlot:
    def __init__(self, serialPort = '/dev/ttyUSB0', serialBaud = 115200, plotLength = 200, dataNumBytes = 2):
        ...
        # 按照字典的格式存储到文件中
        self.topCsvData = []
        self.clfDataFrame = pd.DataFrame(np.arange(9000).reshape(30, 300))
    ...
    def serialConnectionClose(self):
        ...
        dfTop['Fruits'] = 'Apple'
        print(dfTop)
        dfTop.to_csv('/Users/cuizhitong/Desktop/Fruits_Apple.csv')
