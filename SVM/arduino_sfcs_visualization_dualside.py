    ...
    def readSerialPlot(self, linesOneSide, linesDualSide, clf):
        ...
        while (self.isRun):
            ...
            if (value == 1024):
                ...
                plotInteval += 1
                if (plotInteval % 5 == 0):  # 每获得多少帧画个图
                    plotInteval = 0
                    # 滑动平均滤波降噪
                    oneSideData_av = self.movingAverage(self.oneSideData, 10)
                    dualSideData_av = self.movingAverage(self.dualSideData, 10)
                    ...
                    # 画图
                    print(oneSideData_av)
                    print(dualSideData_av)
